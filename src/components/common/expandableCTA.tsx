    ...
    <ExpandableScreen layoutId="cta-card" triggerRadius="100px" contentRadius="24px">
      <div className="relative flex min-h-screen flex-col items-center justify-center px-4 sm:px-6 py-12 sm:py-20">
        <div className="relative z-10 flex flex-col items-center gap-4 sm:gap-6 text-center">
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-medium leading-[120%] tracking-[-0.03em] text-foreground mix-blend-exclusion max-w-2xl">
            Built for the future.
            <br />
            Available Soon.
          </h1>

          <p className="text-base sm:text-lg md:text-xl leading-[160%] text-foreground max-w-3xl px-4">
            Your GTM stack is holding you back. Alpha fixes that. Subheadline: One platform. Every
            channel. AI agents that plan, execute, and optimise your GTM without the 10-tool chaos.
            Join the waitlist and be first in.
          </p>

          <ExpandableScreenTrigger>
            <div className="bg-primary h-15 px-6 sm:px-8 py-3 text-lg sm:text-xl rounded-xl font-regular text-primary-foreground tracking-[-0.01em]">
              Join the waitlist
            </div>
          </ExpandableScreenTrigger>
        </div>
          ...
          <div className="flex-1 flex flex-col justify-center space-y-3 w-full">
            ...
            <div className="pt-6 sm:pt-8 mt-6 sm:mt-8 border-t border-primary-foreground/20">
              <p className="text-lg sm:text-xl lg:text-2xl text-primary-foreground leading-[150%] mb-4">
                Finally — one place where our outreach, campaigns, and pipeline data actually talk
                to each other."
              </p>
              <div className="flex items-center gap-3 sm:gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm sm:text-base text-primary-foreground/70">B2B SaaS</p>
                </div>
              </div>
            </div>
          </div>
